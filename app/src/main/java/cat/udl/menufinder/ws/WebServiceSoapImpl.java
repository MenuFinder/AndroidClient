...
public class WebServiceSoapImpl implements DBManager {
    ...
    public Restaurant getRestaurantById(long restaurantId) {
        return WebServiceUtils.getBean(WebServiceUtils.soap(Path.GET_RESTAURANT_BY_ID, String.valueOf(restaurantId)), Restaurant.class);
    }
    ...
    public boolean updateRestaurant(Restaurant restaurant) {
        return WebServiceUtils.soap(Path.SOAP_UPDATE_RESTAURANT, restaurant);
    }
